...
readonly DEFAULT_VERSION="1.3.0-SNAPSHOT"
readonly DEFAULT_JAVA_RELEASE="25"
...
build_project() {
    ...
    mvn_args+=("-DskipTests")
    mvn_args+=("-Dmaven.compiler.source=${java_release}")
    mvn_args+=("-Dmaven.compiler.target=${java_release}")
