...
import site.ycsb.db.alternator.AlternatorEndpointProvider;
...
public final class DynamoDBClient extends DB {
  ...
  private static volatile AlternatorEndpointProvider sharedEndpointProvider;
  ...
  private AlternatorEndpointProvider createEndpointProvider(java.util.Properties props, String endpoint) {
    return AlternatorEndpointProvider.builder()
        .seedUri(URI.create(endpoint))
        .datacenter(props.getProperty("dynamodb.alternator.datacenter", ""))
        .rack(props.getProperty("dynamodb.alternator.rack", ""))
        .trustAllCertificates(Boolean.parseBoolean(
